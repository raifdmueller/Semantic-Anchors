...
* *Centralized authority*: Each piece of information has one authoritative location
* *Reference relationships*: Other locations reference the single source rather than duplicate it
...
* *Canonical source*: The definitive, trusted source for each data element

*When to Use*:

* Database schema design to eliminate redundant data
* Configuration management across distributed systems
* Documentation systems to avoid conflicting information
* Microservices architecture for authoritative data ownership
...
* *Authoritative source*: One canonical location for each piece of data
...
* *System of record*: The primary data store for critical information
...
*Key Proponent*: Widely used in ML/AI research community; suggested for LLM prompting by Pete Hodgson
