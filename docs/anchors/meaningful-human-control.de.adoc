...
* Die kanonische Referenz ist Santoni de Sio & van den Hoven, https://doi.org/10.3389/frobt.2018.00015["Meaningful Human Control over Autonomous Systems: A Philosophical Account"] (Frontiers in Robotics and AI, 2018), mit den Bedingungen "Tracking" und "Tracing"
