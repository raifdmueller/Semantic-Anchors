...
* Geoffrey K. Pullum, https://www.lel.ed.ac.uk/~gpullum/50years.pdf["50 Years of Stupid Grammar Advice"] (The Chronicle of Higher Education, 2009) — mehrere Grammatik-Behauptungen des Buchs sind sachlich falsch (manche "Passiv"-Beispiele sind gar kein Passiv), und die Autoren verletzen routinemäßig ihre eigenen Regeln; Linguisten kritisieren, dass persönliche Stilvorlieben als Regeln des Englischen ausgegeben werden
