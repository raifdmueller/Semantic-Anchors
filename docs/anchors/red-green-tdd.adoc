...
* David Heinemeier Hansson, https://dhh.dk/2014/tdd-is-dead-long-live-testing.html["TDD is dead. Long live testing."] (2014) — test-first as dogma leads to "test-induced design damage"; the follow-up https://martinfowler.com/articles/is-tdd-dead/["Is TDD Dead?"] conversation series with Kent Beck and Martin Fowler maps the whole debate
* James O. Coplien, https://web.archive.org/web/20230923190457/https://rbcs-us.com/documents/Why-Most-Unit-Testing-is-Waste.pdf["Why Most Unit Testing is Waste"] (2014) — most low-level unit tests provide little assurance relative to their maintenance cost
* Empirical results are mixed: replication studies (e.g. Fucci et al., 2017) suggest observed benefits stem from working in small iterative steps rather than from writing the test first
====
