...
* James O. Coplien, https://rbcs-us.com/documents/Why-Most-Unit-Testing-is-Waste.pdf["Why Most Unit Testing is Waste"] (2014) — most low-level unit tests provide little assurance relative to their maintenance cost
