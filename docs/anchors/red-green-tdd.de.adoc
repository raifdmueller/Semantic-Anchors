...
* David Heinemeier Hansson, https://dhh.dk/2014/tdd-is-dead-long-live-testing.html["TDD is dead. Long live testing."] (2014) — Test-First als Dogma führe zu "test-induced design damage"; die anschließende Gesprächsreihe https://martinfowler.com/articles/is-tdd-dead/["Is TDD Dead?"] mit Kent Beck und Martin Fowler kartiert die gesamte Debatte
* James O. Coplien, https://web.archive.org/web/20230923190457/https://rbcs-us.com/documents/Why-Most-Unit-Testing-is-Waste.pdf["Why Most Unit Testing is Waste"] (2014) — die meisten Low-Level-Unit-Tests liefern wenig Absicherung im Verhältnis zu ihren Wartungskosten
* Die empirische Lage ist gemischt: Replikationsstudien (z. B. Fucci et al., 2017) legen nahe, dass die beobachteten Vorteile aus kleinen iterativen Schritten stammen, nicht aus dem Schreiben des Tests zuerst
====
