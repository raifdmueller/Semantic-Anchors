...
* James O. Coplien, https://rbcs-us.com/documents/Why-Most-Unit-Testing-is-Waste.pdf["Why Most Unit Testing is Waste"] (2014) — die meisten Low-Level-Unit-Tests liefern wenig Absicherung im Verhältnis zu ihren Wartungskosten
