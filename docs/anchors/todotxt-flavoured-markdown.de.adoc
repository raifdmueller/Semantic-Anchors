...
* Das zugrunde liegende todo.txt-Format ist lebendig und kanonisch unter https://todotxt.org/[todotxt.org] (Gina Trapani): eine Aufgabe pro Zeile, Prioritäten als `(A)`, Projekte als `+projekt`, Kontexte als `@kontext`
