...
[TIP]
====
*Try it interactively.* The link:harness-coverage-wheel.html[Harness Coverage Wheel^] turns this inventory into a self-assessment: tick the layers you run and watch coverage grow across the nine sections, filter by risk tier, and click any layer for its explanation. (The layer list, explanations and tier assignments there are LLM-generated suggestions -- adapt them to your project.)
====
...
* link:harness-coverage-wheel.html[Interactive Harness Coverage Wheel^] -- self-assess your harness against this inventory across the nine sections.
